...
def eval_with_average_precision_score(y_true:Union[np.ndarray, pd.Series],
                                      y_score:Union[np.ndarray, pd.Series]) -> float:
    '''This function calculates the average precision score of the model'''
    average_precision = average_precision_score(y_true, y_score)
    return average_precision

def eval_with_auc_and_pr_curve(y_true:Union[np.ndarray, pd.Series],
                               y_score:Union[np.ndarray, pd.Series]) -> float:
...
def eval_with_f_beta_score(y_true:Union[np.ndarray, pd.Series],
                           y_pred:Union[np.ndarray, pd.Series], beta:float=0.5) -> float:
