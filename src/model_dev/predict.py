...
#%%
test = pd.read_parquet("artifacts/data_prep/output/dev.parquet")
test = feature_main(
    input_filepath="artifacts/data_prep/output/dev.parquet",
    output_filepath="artifacts/data_prep/output/assumed_test.parquet",
    ml_datatype="test"
)
test = pd.read_parquet("artifacts/data_prep/output/assumed_test.parquet")
